...
interface LlamaIndexSettingsProps {
    isExpanded?: boolean;
    onExpandedChange?: (expanded: boolean) => void;
    logo?: LogoProps;
}

const LlamaIndexSettings: React.FC<LlamaIndexSettingsProps> = ({
        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-base font-medium text-gray-200">LlamaIndex</h3>
                        <p className="text-sm text-gray-400">Build advanced workflows and knowledge assistants with LlamaIndex</p>
                    </div>
                </div>
                <button
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                ...
                <div className="p-6 bg-gray-800/30 rounded-lg text-center">
                    ...
                    <p className="text-sm text-gray-400">
                        LlamaIndex integration is currently under development. Stay tuned for updates!
                    </p>
                </div>
            </div>
        </div>
...
export default LlamaIndexSettings; 